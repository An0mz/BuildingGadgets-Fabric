...
public class BuildingGadgetsClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        // World rendering is handled by LevelRendererMixin which adds a custom
        // frame-graph pass after "late_debug". This replaces the old
        // WorldRenderEvents.END_MAIN approach (that API was removed in Fabric API
        // 0.134+/MC 1.21.9).
