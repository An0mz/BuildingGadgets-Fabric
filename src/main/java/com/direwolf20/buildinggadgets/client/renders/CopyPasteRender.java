...
public class CopyPasteRender extends BaseRenderer implements IUpdateListener {
    ...
    private void renderCopy(PoseStack matrix, Region region) {
        ...
        LevelRenderer.renderLineBox(matrix, buffer.getBuffer(OurRenderTypes.CopyGadgetLines), new AABB(Vec3.atLowerCornerOf(region.getMin()), Vec3.atLowerCornerOf(region.getMax().offset(1, 1, 1))), R / 255f, G / 255f, B / 255f, 1f);
    }
